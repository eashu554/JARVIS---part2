...
def wishMe():
    ...
    if hour >= 0 and hour < 12:
        speak("Good Morning monesh")
    elif hour >= 12 and hour < 18:
        speak("Good Afternoon monesh")

    else:
        speak('Good Evening monesh')

    weather()
    speak('I am JARVIS. Please tell me how can I help you monesh?')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak("Hello monesh, I have switched my voice. How is it?")

        if 'jarvis are you there' in query:
            speak("Yes monesh, at your service")
            ...
            speak(f'monesh, the time is {strTime}')
            ...
            if platform == "win32" or "darwin":
                speak('Monesh is my master. He created me couple of days ago')
            ...
            speak("what should i remember monesh")
            ...
            speak('Ofcourse monesh..')
            speak_news()
            speak('Do you want to read the full news...')
            test = takeCommand()
            if 'yes' in test:
                speak('Ok monesh, Opening browser...')
                webbrowser.open(getNewsUrl())
                speak('You can now read the full news from this website.')
            else:
                speak('No Problem monesh')
            ...
            try:
                ...
                speak('Sorry monesh, Not able to send email at the moment')